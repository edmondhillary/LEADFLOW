...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article>
      {/* Hero */}
      <section style={{ backgroundColor: '#FBFBE2', padding: '80px 0 0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px' }}>
          {/* Breadcrumb */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '32px', fontSize: '12px', fontFamily: "'Manrope', sans-serif" }}>
            <Link href="/template-restaurante" style={{ color: '#735C00', textDecoration: 'none' }}>Home</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
            <Link href="/template-restaurante/blog" style={{ color: '#735C00', textDecoration: 'none' }}>Blog</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '20px' }}>
            <span style={{ fontSize: '11px', fontWeight: 700, color: '#735C00', textTransform: 'uppercase', letterSpacing: '0.15em', fontFamily: "'Manrope', sans-serif" }}>
              {post.category}
            </span>
            {'readTime' in post && (
          ...
          {/* Title */}
          <h1 style={{ fontSize: 'clamp(28px, 5vw, 48px)', fontWeight: 800, lineHeight: 1.15, letterSpacing: '-0.02em', color: '#1B1D0E', fontFamily: "'Noto Serif', serif", marginBottom: '24px' }}>
            {post.title}
          </h1>
      ...
      {/* Article body */}
      <section style={{ backgroundColor: '#F5F5DC', padding: '64px 0 80px' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 24px' }}>
          ...
          {[
            ...
            <p key={i} style={{ fontSize: '17px', lineHeight: 1.8, color: '#1B1D0E', fontFamily: "'Manrope', sans-serif", marginBottom: '28px', opacity: i === 0 ? 1 : 0.85 }}>
              {paragraph}
            </p>
          ))}

          {/* CTA block */}
          <div style={{ borderLeft: '4px solid #735C00', paddingLeft: '24px', marginTop: '48px', marginBottom: '48px', backgroundColor: '#F5F5DC', padding: '24px 24px 24px 28px', borderRadius: '0 8px 8px 0' }}>
            <p style={{ fontSize: '16px', fontWeight: 600, color: '#1B1D0E', fontFamily: "'Noto Serif', serif", marginBottom: '8px' }}>
            ...
            <Link
              ...
              style={{ display: 'inline-block', padding: '10px 24px', backgroundColor: '#735C00', color: '#FBFBE2', fontFamily: "'Manrope', sans-serif", fontSize: '13px', fontWeight: 700, textDecoration: 'none', borderRadius: '6px', textTransform: 'uppercase', letterSpacing: '0.1em' }}
            >
              Contactar ahora
            </Link>
          </div>
          ...
          {/* Back to blog */}
          <div style={{ paddingTop: '32px', borderTop: '1px solid #F5F5DC' }}>
            <Link
              href="/template-restaurante/blog"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#735C00', fontFamily: "'Manrope', sans-serif", fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}
            >
