...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article>
      {/* Hero */}
      <section style={{ backgroundColor: '#faf9f6', padding: '80px 0 0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px' }}>
          {/* Breadcrumb */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '32px', fontSize: '12px', fontFamily: "'Manrope', sans-serif" }}>
            <Link href="/template-pilates" style={{ color: '#536257', textDecoration: 'none' }}>Home</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
            <Link href="/template-pilates/blog" style={{ color: '#536257', textDecoration: 'none' }}>Blog</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '20px' }}>
            <span style={{ fontSize: '11px', fontWeight: 700, color: '#536257', textTransform: 'uppercase', letterSpacing: '0.15em', fontFamily: "'Manrope', sans-serif" }}>
              {post.category}
            </span>
            {'readTime' in post && (
          ...
          {/* Title */}
          <h1 style={{ fontSize: 'clamp(28px, 5vw, 48px)', fontWeight: 800, lineHeight: 1.15, letterSpacing: '-0.02em', color: '#2f3430', fontFamily: "'Noto Serif', serif", marginBottom: '24px' }}>
            {post.title}
          </h1>
      ...
      {/* Article body */}
      <section style={{ backgroundColor: '#edeeea', padding: '64px 0 80px' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 24px' }}>
          ...
          {[
            ...
            <p key={i} style={{ fontSize: '17px', lineHeight: 1.8, color: '#2f3430', fontFamily: "'Manrope', sans-serif", marginBottom: '28px', opacity: i === 0 ? 1 : 0.85 }}>
              {paragraph}
            </p>
          ))}

          {/* CTA block */}
          <div style={{ borderLeft: '4px solid #536257', marginTop: '48px', marginBottom: '48px', backgroundColor: '#f4f4f0', padding: '24px 24px 24px 28px', borderRadius: '0 8px 8px 0' }}>
            <p style={{ fontSize: '16px', fontWeight: 600, color: '#2f3430', fontFamily: "'Noto Serif', serif", marginBottom: '8px' }}>
            ...
            <Link
              ...
              style={{ display: 'inline-block', padding: '10px 24px', backgroundColor: '#536257', color: '#ebfced', fontFamily: "'Manrope', sans-serif", fontSize: '13px', fontWeight: 700, textDecoration: 'none', borderRadius: '6px', textTransform: 'uppercase', letterSpacing: '0.1em' }}
            >
              Contactar ahora
            </Link>
          </div>
          ...
          {/* Back to blog */}
          <div style={{ paddingTop: '32px', borderTop: '1px solid #edeeea' }}>
            <Link
              href="/template-pilates/blog"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#536257', fontFamily: "'Manrope', sans-serif", fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}
            >
