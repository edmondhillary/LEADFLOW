...
import { hero, images, benefits, statusConduit, business } from './data';

export default function ElectricistaHome() {
  return (
    <>
      {/* ─── HERO ─── */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-7 group relative overflow-hidden bg-[#f6f3f2] p-10 min-h-[400px] flex flex-col justify-end">
            ...
            <div className="relative z-10">
              <span className="text-[#705d00] font-black text-sm uppercase tracking-widest block mb-4">Urgencia 01</span>
              <h3 className="text-4xl font-black uppercase tracking-tighter mb-4">Reparación de Averías</h3>
              <p className="text-[#5f5e5e] mb-8 max-w-md">
                Localización de fallos a tierra, cortocircuitos y sobrecargas. Intervención inmediata con equipo de diagnóstico avanzado.
              </p>
              <ul className="space-y-2 mb-8 font-bold text-xs uppercase tracking-tight text-[#4d4732]">
                <li>Localización de fugas</li>
                <li>Reactivación de ICP/IGA</li>
                <li>Sustitución de cableado quemado</li>
              </ul>
              <Link
          ...
          <div className="md:col-span-5 bg-[#1c1b1b] text-white p-10 flex flex-col justify-between">
            <div>
              <span className="text-[#ffd700] font-black text-sm uppercase tracking-widest block mb-4">Sistemas 02</span>
              <h3 className="text-3xl font-black uppercase tracking-tighter mb-4">Cuadros Eléctricos</h3>
            </div>
            <div className="bg-white/5 p-6 backdrop-blur-sm">
              <p className="text-[#e5e2e1] text-sm mb-6">
                Montaje y saneamiento de cuadros según normativa REBT. Protección magnetotérmica y diferencial de alta sensibilidad.
              </p>
              {/* Status bar */}
          ...
          <div className="md:col-span-5 bg-[#f0eded] p-10">
            <span className="text-[#705d00] font-black text-sm uppercase tracking-widest block mb-4">Proyectos 03</span>
            <h3 className="text-3xl font-black uppercase tracking-tighter mb-6">Instalaciones &amp; Boletines</h3>
            <img
            ...
            <p className="text-[#5f5e5e] text-sm">
              Altas nuevas, aumentos de potencia y certificados de eficiencia energética para viviendas y locales.
            </p>
          </div>
        ...
        <div className="bg-[#1c1b1b] text-white p-12 md:p-24 flex flex-col justify-center">
          ...
          <form className="space-y-8 max-w-md" onSubmit={(e) => e.preventDefault()}>
            {[
              ...
              { label: 'Ubicación / Código Postal', placeholder: 'ZONA DE MADRID', type: 'text' },
            ].map((field) => (
        ...
        <div className="min-h-[500px] relative grayscale">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#1c1b1b] p-6 shadow-2xl">
            <div className="flex items-center gap-4">
              ...
              <span className="text-white font-black uppercase tracking-tighter text-sm">Unidades móviles activas en Madrid</span>
            </div>
          </div>
        </div>
      </section>
