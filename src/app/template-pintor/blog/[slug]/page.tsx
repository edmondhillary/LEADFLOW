...
export default async function BlogPostPage({
  ...
  return (
    <article>
      <section style={{ backgroundColor: '#f8f5f0', padding: '72px 0 0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px' }}>
          <nav style={{ display: 'flex', gap: '8px', alignItems: 'center', fontSize: '12px', marginBottom: '28px', fontFamily: "'Inter', sans-serif" }}>
            <Link href="/template-pintor" style={{ color: '#d97706', textDecoration: 'none' }}>Inicio</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
            <Link href="/template-pintor/blog" style={{ color: '#d97706', textDecoration: 'none' }}>Blog</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
            <span style={{ color: '#9ca3af' }}>{post.title.slice(0, 40)}</span>
          </nav>
          {'category' in post && (
            <p style={{ fontSize: '11px', fontWeight: 700, color: '#d97706', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '16px', fontFamily: "'Inter', sans-serif" }}>
          ...
          <h1 style={{ fontSize: 'clamp(28px, 5vw, 44px)', fontWeight: 800, lineHeight: 1.2, letterSpacing: '-0.02em', color: '#2c2416', fontFamily: "'Manrope', sans-serif", marginBottom: '24px' }}>
            {post.title}
          </h1>
      ...
      <section style={{ backgroundColor: '#f0ebe3', padding: '64px 0 80px' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 24px' }}>
          {[
            ...
            <p key={i} style={{ fontSize: '17px', lineHeight: 1.85, color: '#2c2416', fontFamily: "'Inter', sans-serif", marginBottom: '28px', opacity: i === 0 ? 0.95 : 0.82 }}>
              {para}
            </p>
          ))}

          <div style={{ borderLeft: '3px solid #d97706', margin: '48px 0', backgroundColor: '#fdf8f2', padding: '20px 20px 20px 24px', borderRadius: '0 8px 8px 0' }}>
            <p style={{ fontSize: '15px', fontWeight: 600, color: '#2c2416', fontFamily: "'Manrope', sans-serif", marginBottom: '8px' }}>Hablemos de tu proyecto</p>
            ...
            <Link href="/template-pintor/contacto" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#d97706', color: '#ffffff', fontSize: '12px', fontWeight: 700, textDecoration: 'none', borderRadius: '6px', textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: "'Inter', sans-serif" }}>
              Contactar
            </Link>
          </div>

          <Link href="/template-pintor/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#d97706', fontFamily: "'Inter', sans-serif", fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>
