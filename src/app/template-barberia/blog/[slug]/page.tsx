...
export default async function BlogPostPage({
  ...
  return (
    <article>
      ...
      <section style={{ backgroundColor: '#131313', padding: '72px 0 0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px' }}>
          <nav style={{ display: 'flex', gap: '8px', alignItems: 'center', fontSize: '12px', marginBottom: '28px', fontFamily: "'Inter', sans-serif" }}>
            <Link href="/template-barberia" style={{ color: '#e9c176', textDecoration: 'none' }}>Inicio</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
            <Link href="/template-barberia/blog" style={{ color: '#e9c176', textDecoration: 'none' }}>Blog</Link>
            <span style={{ color: '#9ca3af' }}>/</span>
            <span style={{ color: '#9ca3af' }}>{post.title.slice(0, 40)}{post.title.length > 40 ? '...' : ''}</span>
          </nav>

          {'category' in post && (
            <p style={{ fontSize: '11px', fontWeight: 700, color: '#e9c176', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '16px', fontFamily: "'Inter', sans-serif" }}>
          ...
          <h1 style={{ fontSize: 'clamp(28px, 5vw, 44px)', fontWeight: 800, lineHeight: 1.2, letterSpacing: '-0.02em', color: '#e5e2e1', fontFamily: "'Newsreader', serif", marginBottom: '24px' }}>
            {post.title}
          </h1>
      ...
      {/* Body */}
      <section style={{ backgroundColor: '#201f1f', padding: '64px 0 80px' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 24px' }}>
          ...
          {/* CTA */}
          <div style={{ borderLeft: '3px solid #e9c176', paddingLeft: '20px', margin: '48px 0', backgroundColor: '#1c1b1b', padding: '20px 20px 20px 24px', borderRadius: '0 8px 8px 0' }}>
            <p style={{ fontSize: '15px', fontWeight: 600, color: '#e5e2e1', fontFamily: "'Newsreader', serif", marginBottom: '8px' }}>
            ...
            <Link href="/template-barberia/contacto" style={{ display: 'inline-block', padding: '10px 20px', backgroundColor: '#e9c176', color: '#412d00', fontSize: '12px', fontWeight: 700, textDecoration: 'none', borderRadius: '6px', textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: "'Inter', sans-serif" }}>
              Contactar
            </Link>
          </div>

          <Link href="/template-barberia/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#e9c176', fontFamily: "'Inter', sans-serif", fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>
